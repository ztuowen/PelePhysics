...
contains
  ...
  subroutine initialize_data( &
    ...
    real(amrex_real), intent(inout) ::   Y(Y_lo(1):Y_hi(1),Y_lo(2):Y_hi(2),Y_lo(3):Y_hi(3),nspecies)
    ...
    do k = lo(3),hi(3)
       ...
       do j = lo(2),hi(2)
          ...
          do i = lo(1),hi(1)
             ...
             Y(i,j,k,1:nspecies)    = eos_state % massfrac !* eos_state % rho
    ...
    print *, " cell count is ", count_cells
