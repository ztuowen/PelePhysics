...
class FPickler(CMill):
    ...
    def _ckrp(self, mechanism):
        ...
        self._write('subroutine ckrp'+sym+'(ru, ruc, pa)')
        self._write()
        self._indent()
        self._write('implicit none')
        self._write()
    ...
    def _ckindx(self, mechanism):
        ...
        self._write('subroutine ckindx'+sym+'(mm, kk, ii, nfit)')
        self._write()
        self._indent()
        self._write('implicit none')
        self._write()
    ...
    def _ckpy(self, mechanism):
        ...
        self._write('subroutine ckpy'+sym+'(rho, T, y, P)')
        self._write()
        self._indent()
    ...
    def _ckrhoy(self, mechanism):
        ...
        self._write('subroutine ckrhoy'+sym+'(P, T, y, rho)')
        self._write()
        self._indent()
        self._write('implicit none')
        self._write()
    ...
    def _ckwt(self, mechanism):
        ...
        self._write('subroutine ckwt'+sym+'(wt)')
        self._write()
        self._indent()
        self._write('implicit none')
        self._write()
    ...
    def _ckums(self, mechanism):
        ...
        self._write('subroutine ckums'+sym+'(T, ums)')
        self._write()
        self._indent()
        self._write('implicit none')
        self._write()
    ...
    def _ckhms(self, mechanism):
        ...
        self._write('subroutine ckhms'+sym+'(T, hms)')
        self._write()
        self._indent()
        self._write('implicit none')
        self._write()
    ...
    def _vckhms(self, mechanism):
        ...
        self._write()
        self._write('! Returns enthalpy in mass units (Eq 27.)')
        self._write('subroutine vckhms'+sym+'(np, T, hms)')
        self._indent()
        self._write()
        self._write('implicit none')
        self._write()
    ...
    def _ckcvms(self, mechanism):
        ...
        self._write('subroutine ckcvms'+sym+'(T, cvms)')
        self._write()
        self._indent()
        self._write('implicit none')
        self._write()
    ...
    def _ckcpms(self, mechanism):
        ...
        self._write('subroutine ckcpms'+sym+'(T, cpms)')
        self._write()
        self._indent()
        self._write('implicit none')
        self._write()
    ...
    def _ckcpbs(self, mechanism):
        ...
        self._write('subroutine ckcpbs'+sym+'(T, y, cpbs)')
        self._write()
        self._indent()
        self._write('implicit none')
        self._write()
    ...
    def _ckcvbs(self, mechanism):
        ...
        self._write('subroutine ckcvbs'+sym+'(T, y, cvbs)')
        self._write()
        self._indent()
        self._write('implicit none')
        self._write()
    ...
    def _ckubms(self, mechanism):
        ...
        self._write('subroutine ckubms'+sym+'(T, y, ubms)')
        self._write()
        self._indent()
        self._write('implicit none')
        self._write()
    ...
    def _ckwc(self, mechanism):
        ...
        self._write('subroutine ckwc'+sym+'(T, C, wdot)')
        self._write()
        self._indent()
        self._write('implicit none')
        self._write()
    ...
    def _ckytx(self, mechanism):
        ...
        self._write('subroutine ckytx'+sym+'(y, x)')
        self._write()
        self._indent()
        self._write('implicit none')
        self._write()
    ...
    def _vckytx(self, mechanism):
        ...
        self._write('subroutine vckytx'+sym+'(np, y, x)')
        self._write()
        self._indent()
        self._write('implicit none')
        self._write()
    ...
    def _ckytcr(self, mechanism):
        ...
        self._write('subroutine ckytcr'+sym+'(rho, T, y, c)')
        self._write()
        self._indent()
        self._write('implicit none')
        self._write()
    ...
    def _ckxty(self, mechanism):
        ...
        self._write('subroutine ckxty'+sym+'(x, y)')
        self._write()
        self._indent()
        self._write('implicit none')
        self._write()
...
# Fuego's core routines section begins here
    ...
    def _T_given_ey(self, mechanism):
        ...
        self._write('subroutine get_t_given_ey(e, y, t, ierr)')
        self._write()
        self._indent()
        self._write('implicit none')
        self._write()
        ...
        self._write('ein = e')
        self._write()
        self._write('call ckubms(tmin, y, emin)')
        self._write('call ckubms(tmax, y, emax)')
        self._write()
        self._write('if (ein < emin) then')
        self._indent()
        self._write('! Linear Extrapolation below tmin')
        self._write('call ckcvbs(tmin, y, cv)')
        self._write('t = tmin - (emin-ein) / cv')
        self._write('ierr = 1')
        self._write('return')
        self._outdent()
        ...
        self._write('call ckcvbs(tmax, y, cv)')
        self._write('t = tmax - (emax - ein) / cv')
        self._write('ierr = 1')
        self._write('return')
        self._outdent()
        ...
        self._indent()
        self._write('call ckubms(t1,y,e1)')
        self._write('call ckcvbs(t1,y,cv)')
        self._write('dt = (ein - e1) / cv')
